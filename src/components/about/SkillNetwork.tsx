...
const SkillNetwork: React.FC = () => {
  ...
  useEffect(() => {
    ...
    const getGroup = (node: Node) => groups.find((g) => g.nodes.includes(node.text));
    ...
    function drawBackgroundText() {
      ...
      ctx.strokeText("Tools I use", BOUNDS.width / 2, BOUNDS.height / 2);
      ctx.restore();
    }
  ...
  return (
    <section
      className="relative w-full h-[600px] bg-[#111] overflow-hidden"
      style={{ fontFamily: "'Poller One', sans-serif" }}
    >
      <canvas
        ref={canvasRef}
        id="network"
